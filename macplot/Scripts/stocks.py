...
def main():
    ...
    plt.plot(indeces, closes(rows), label="GOOG")
    plt.plot(indeces, closes(query("AAPL")), label="AAPL")
    plt.plot(indeces, closes(query("MSFT")), label="MSFT")
    plt.plot(indeces, closes(query("AMZN")), label="AMZN")
    plt.plot(indeces, closes(query("FB")), label="FB")
    plt.legend(loc='best')
